## Initial prompt:
IMPORTANT: Before doing anything, read and load all rules from AGENTS.md. Treat AGENTS.md as the primary instruction source for this project. You must follow it throughout the entire session.
===
...
===
Instructions on should be inside the README.md file:
